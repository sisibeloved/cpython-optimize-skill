...
面向个人工作流的 CPython/CinderX 性能优化与设计文档技能集合，以 [Claude Code 技能插件](https://agentskills.io/) 形式交付。覆盖从远程环境搭建到实验文档沉淀、设计文档编写的完整闭环。

## 技能概览

本仓库包含 8 个自包含技能，每个技能独立拥有 SKILL.md、参考文档、脚本和模板：
...
| `design-documentation` | 架构设计、系统设计、功能设计、详细设计文档模板 | references/ |
